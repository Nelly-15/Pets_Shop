...
<head>
	...
	<title>¿QUIENES SOMOS? |Pets shop</title>
...
<label><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
...
<main class="container">
  <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
    <div class="col-md-6 px-0">
      <h1 class="display-4 fst-italic"><img src="Images/Adopta.jpg" height="350" width="825" style="border: double hotpink;"></h1>
      <section>
      <center><img src="Images/Logo.jpg"></center>
      <img src="Images/shop.png" height="70" align="left"><p>Pets shop es una casa dedicada a dar refugio y cobijo a una diversidad de mascotas en situacion de calle, les ofrecemos un hogar, alimento y servicios medicos entre otras cosas
      </p>
      <img src="Images/dog.png" height="100" align="right"><p>esta mision de proteger, alimentar y dar refugio a las mascotas nace hace 2 años en la ciudad de Montemorelos N.L. A lo largo de este tiempo la institucion ha ido creciendo de la mano de personas amantes de los animales, lo que representa un paso muy importante para lograr mejorar dia con dia.</p>
      <p><img src="Images/Adopta.jpg" height="70">Contribuimos a crear un mundo mejor, ayudando a amar y proteger a sus mascotas. Basados en nuestro equipo de trabajo somos solidarios socialmente, brindando la mayor cantidad de trabajo posible, innovando constantemente y logrando un prestigio que nos haga perdurar en el tiempo. Invirtiendo e innovando en proyectos para ampliar la estructura y seguir creciendo en otras ciudades. Aportando y participando solidariamente para crear una comunidad inclusiva y el cuidado del medio ambiente.</p>
      <iframe width="400" height="350" src="https://www.youtube.com/embed/mlfzDp9rjos" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen> </iframe>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<iframe width="400" height="350" src="https://www.youtube.com/embed/nU9IYm3PRWU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </section>
  <main class="shrink">
