...
<head>
	...
	<title>Adoptame |Pets shop</title>
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
	...
	.container{
		background-image: linear-gradient(to top, #ffffff 5%, #000000 10%, #e6dee9 100%);
		height: 450px;
		width: 900px;
	}
	p{
...
<body>
    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">¡Adopa, no compres!</h1>
      </div>
    </div>
  </section>
  <div class="col">
          <div class="card shadow-sm">
            <img src="Images/Cartoon.png" class="Perritos">

            <div class="card-body">
                  <center><a href=""><button type="button" class="btn btn-sm btn-outline-secondary">ver perritos</button></a></center>
        </div>
        <div class="col">
          <center><div class="card shadow-sm">
            <img src="Images/fox.jpg" class="Perritos"></center>

            <div class="card-body">
                  <center><a href=""><button type="button" class="btn btn-sm btn-outline-secondary">ver zorritos</button></a></center>
        </div>
        <div class="col">
          <div class="card shadow-sm">
            <img src="Images/GATITO.jpg" class="Perritos">

            <div class="card-body">
                  <center><a href=""><button type="button" class="btn btn-sm btn-outline-secondary">ver gagitos</button></a></center>
  </div>
</main>
...
<main class="flex-shrink-0">
  <div class="navbar navbar-dark bg-dark">
    ...
    <p class="navbar navbar-dark bg-dark">En Pets shop estamos a sus ordenes, nada nos da mas gusto que ver a las familias adoptar a un nuevo integrante.
  </div>
