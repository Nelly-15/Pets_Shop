...
<body>
  ...
  <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
                  <center><a href="<?php echo base_url(); ?>Cperritos"><button type="button" class="btn btn-sm btn-outline-secondary">ver perritos</button></a></center>
        </div>
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
                  <center><a href="<?php echo base_url() ?>Cgatitos"><button type="button" class="btn btn-sm btn-outline-secondary">ver gatitos</button></a></center>
  </div>
</main>
...
<main class="flex-shrink-0">
  <div class="navbar navbar-dark bg-dark">
    ...
    <p class="pets">En Pets shop estamos a sus ordenes, nada nos da mas gusto que ver a las familias adoptar a un nuevo integrante.
  </div>
